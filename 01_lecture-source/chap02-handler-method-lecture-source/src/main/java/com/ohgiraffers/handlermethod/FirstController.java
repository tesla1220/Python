...
public class FirstController {
    ...
    * */
    ...
    /* 필기.
        ...
        클래스 레벨이 @SessionAttributes 어노테이션을 이용하여
        세션에 값을 담을 key 값을 설정해두면
        Model 영역에 해당 key 로 값이 추가되는 경우 session에 자동 등록을 해준다.
     */
    ...
    * JSON 으로 전달하는 경우 Jackson 의 컨버터로 자동 피싱하여 사용할 수 있다.
    *
